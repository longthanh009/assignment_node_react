                ...
                <div className="">
                    <div className="mt-4">
                        <div className="w-full mb-[10px]">
                            <label htmlFor="Email" className="block mb-3 text-sm font-semibold text-gray-500">Product Name</label>
                        ...
                        <div className="w-full  mb-[10px]">
                            <label htmlFor="Email" className="block mb-3 text-sm font-semibold text-gray-500">Price</label>
                            <input  {...register('name', { required: true })} type="text" placeholder="...." className="w-full px-4 py-3 text-sm border border-gray-300 rounded lg:text-sm focus:outline-none focus:ring-1 focus:ring-blue-600" />
                        </div>
                        <div className="w-full  mb-[10px]">
                            <label htmlFor="Email" className="block mb-3 text-sm font-semibold text-gray-500">Image</label>
                            <input  {...register('name', { required: true })} type="file" placeholder="...." className="w-full px-4 py-3 text-sm border border-gray-300 rounded lg:text-sm focus:outline-none focus:ring-1 focus:ring-blue-600" />
                        </div>
                    </div>
